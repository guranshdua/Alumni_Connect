             ...
             <div class="col-12">
               <form>
                 <div class="form-group row">
                  <label for="Post" class="col-sm-3 col-form-label">Old Password</label>
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="Post" placeholder="">
                  </div>
                 </div>
                 <div class="form-group row">
                   <label for="Organisation" class="col-sm-3 col-form-label">New Password</label>
                   <div class="col-sm-9">
                   <input type="password" class="form-control" id="Organisation" placeholder="">
                 </div>
               </div>
               <div class="form-group row">
                <label for="Location" class="col-sm-3 col-form-label">Confirm Password</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" id="Location" placeholder="">
                </div>
              </div>
