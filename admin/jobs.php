         ...
         <div class="row">
           ...
           <div class="col" style="padding-right:30px">
             <div class="row">
               <div class="col-md-12">
                 <br /><br /><br /><br />
                 <button class="btn btn-info" style="width:100%; text-align:left;" id="toggle-button">Add new opportunity</button>
                   ...
                   <div class="card ml-auto mr-auto " style="width:100%;">
                     <div class="card-body">
                       <form>
                         ...
                         <div class="form-group row">
                           <label for="Organisation" class="col-sm-3 col-form-label">Company</label>
                           <div class="col-sm-9">
                     ...
                     <div class="form-group row">
                      <label for="Perks" class="col-sm-3 col-form-label">Perks</label>
                      <div class="col-sm-9">
